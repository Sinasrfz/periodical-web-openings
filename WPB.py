...
def load_model(label_name):
    ...
    model_path = f"Inverse-december/{model_name}_best_model({label_name}).joblib"
    try:
...
# Reference table for sets of section properties
reference_sets = [
    [177.8, 101.2, 4.8, 7.9],
    [305.1, 101.6, 5.8, 7],
...
try:
    image = Image.open("Inverse-december/picture1.jpg")
    st.image(image, caption="Structural Features Visualization", use_column_width=True)
